...
export class QuizCardsComponent implements OnInit {
  ...
  constructor(
    ...
    quizCard.selection = true;
    quizCard.gameMode = QuizGameModes.LimitedTime;
    ...
    quizCard.selection = true;
    quizCard.gameMode = QuizGameModes.XQUestions;
    ...
    quizCard.selection = true;
    quizCard.gameMode = QuizGameModes.Expert;
    quizCard.selectionLabel = 'Select a number of questions';
    ...
    quizCard.selection = true;
    quizCard.gameMode = QuizGameModes.Training;
    ...
    quizCard.selection = false;
    quizCard.gameMode = QuizGameModes.Adventure;
    this.quizCards.push(quizCard);
  }
